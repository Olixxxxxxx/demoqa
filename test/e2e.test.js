...
describe("Practice Form Test", function () {
  beforeEach(async () => {
    ...
    browser.config.windowWidth = "1600";
  ...
  document.querySelectorAll('iframe, .adsbygoogle, [id*="ad"], [class*="ad"], .ad-banner, .popup-ad')
...
`)
    ...
    await browser
      .element('.react-datepicker__month-select [value="7"]')
      .click();
    await browser.element(".react-datepicker__year-select").click();
    await browser
      .element('.react-datepicker__year-select [value="1989"]')
      .click();
